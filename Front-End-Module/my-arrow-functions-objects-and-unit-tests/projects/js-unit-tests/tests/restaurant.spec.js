...
/*
  ...
  //     consumption: [];
  //     order: () => {
  //       meuRestaurante.consumption.push();
  //     }
  //     pay: () => {
...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const menuKeys = Object.keys(returnedObject.fetchMenu());
    assert.deepStrictEqual(menuKeys, ['food', 'drink']);
    ...
    returnedObject.order('água');

    assert.deepStrictEqual(returnedObject.consumption, ['coxinha', 'água']);
    ...
    assert.deepStrictEqual(returnedObject.consumption, ['coxinha', 'água', 'sopa', 'sashimi']);
    ...
    assert.deepStrictEqual(returnedObject.consumption, ['coxinha', 'água', 'coxinha']);
    ...
    returnedObject.order('água');
    returnedObject.order('coxinha');
    const sumOfOrdersConsumption = 12.87;

    assert.strictEqual(returnedObject.pay(), sumOfOrdersConsumption);
